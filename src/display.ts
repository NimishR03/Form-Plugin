import { isTextLayer, isFrameAllText, checkLabel, obtainName, orientation } from "./util";
...
export function createObjDisplay (name,orientation,children){ // Creates the object with its direction and Children array
    if(orientation===1){
      return {
